...
Pgn pgnList[] = {
    ...
    {"Simnet: Device Status",
     ...
     {COMPANY(1857),
      ...
      MATCH_LOOKUP_FIELD(PK("Report"), BYTES(1), 2, SIMNET_DEVICE_REPORT),
    ...
    {"Simnet: Device Status Request",
     ...
     {COMPANY(1857),
      LOOKUP_FIELD("Model", BYTES(1), SIMNET_DEVICE_MODEL),
      MATCH_LOOKUP_FIELD(PK("Report"), BYTES(1), 3, SIMNET_DEVICE_REPORT),
      SPARE_FIELD(BYTES(4)),
      END_OF_FIELDS},
     .interval    = 1000,
    ...
    {"Simnet: Pilot Mode",
     ...
     {COMPANY(1857),
      LOOKUP_FIELD("Model", BYTES(1), SIMNET_DEVICE_MODEL),
      MATCH_LOOKUP_FIELD(PK("Report"), BYTES(1), 10, SIMNET_DEVICE_REPORT),
    ...
    {"Simnet: Device Mode Request",
     ...
     {COMPANY(1857),
      LOOKUP_FIELD("Model", BYTES(1), SIMNET_DEVICE_MODEL),
      MATCH_LOOKUP_FIELD(PK("Report"), BYTES(1), 11, SIMNET_DEVICE_REPORT),
      SPARE_FIELD(BYTES(4)),
      END_OF_FIELDS},
     .interval    = 1000,
     .explanation = "This PGN is sent by an active AutoPilot head controller (AP, MFD, Triton2)."
    ...
    {"Simnet: Sailing Processor Status",
     ...
     {COMPANY(1857),
      LOOKUP_FIELD("Model", BYTES(1), SIMNET_DEVICE_MODEL),
      MATCH_LOOKUP_FIELD(PK("Report"), BYTES(1), 23, SIMNET_DEVICE_REPORT),
    ...
    {"Yamaha: Gear Status",
     ...
     {COMPANY(198),
      RESERVED_FIELD(BYTES(3)),
      RESERVED_FIELD(1),
      LOOKUP_FIELD("Neutral", 1, YES_NO_1BIT),
      RESERVED_FIELD(6),
      RESERVED_FIELD(BYTES(2)),
      END_OF_FIELDS},
    ...
    {"Garmin AHRS ATT: COG Source Valid Flag",
     ...
     PACKET_FAST,
     { COMPANY(229),
      MATCH_LOOKUP_FIELD(PK("Sub-protocol ID"), BYTES(2), 1900, GARMIN_MESSAGE_ID),
      MATCH_FIELD("Wrapper Byte 1", BYTES(1), 2, "1"),
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 2, "2"),
      MATCH_LOOKUP_FIELD(PK("ATT Message ID"), BYTES(2), 67, GARMIN_ATT_MESSAGE_ID),
    ...
    {"Garmin AHRS ATT: Device Flags",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 1", BYTES(1), 2, "1"),
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 2, "2"),
      MATCH_LOOKUP_FIELD(PK("ATT Message ID"), BYTES(2), 65, GARMIN_ATT_MESSAGE_ID),
    ...
    {"Garmin AHRS ATT: Non-default Calibration Matrix Present",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 1", BYTES(1), 2, "1"),
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 2, "2"),
      MATCH_LOOKUP_FIELD(PK("ATT Message ID"), BYTES(2), 40, GARMIN_ATT_MESSAGE_ID),
    ...
    {"Garmin AHRS ATT: Set North State",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 1", BYTES(1), 2, "1"),
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 2, "2"),
      MATCH_LOOKUP_FIELD(PK("ATT Message ID"), BYTES(2), 52, GARMIN_ATT_MESSAGE_ID),
      UINT8_FIELD("Set North State"),
      END_OF_FIELDS } }

    /* Garmin autopilot scalar transport: a separate Garmin sub-protocol (ID 5904) that carries a single named
       scalar per frame, selected by the Field Group + Field bytes. Structure inferred from the canboat-py-gh
       extended decoder; the byte between the Field selector and the value is not yet identified. */
    ...
    {"Garmin Autopilot: Heading to Steer",
     ...
     PACKET_FAST,
     { COMPANY(229),
      MATCH_LOOKUP_FIELD(PK("Sub-protocol ID"), BYTES(2), 5904, GARMIN_MESSAGE_ID),
      MATCH_FIELD("Wrapper Byte 1", BYTES(1), 4, "4"),
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 0, "0"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 11, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Garmin Autopilot: Rate of Turn",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 0, "0"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 114, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
      FLOAT_FIELD("Rate of Turn", "FLOAT_RAD_S", NULL),
      END_OF_FIELDS },
     .priority    = 7}
    ...
    {"Garmin Autopilot: Rate of Turn Order",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 0, "0"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 115, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
      FLOAT_FIELD("Rate of Turn Order", "FLOAT_RAD_S", NULL),
      END_OF_FIELDS },
     .priority    = 7}
    ...
    {"Garmin Autopilot: Speed",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 0, "0"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 246, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
      FLOAT_FIELD("Speed", "FLOAT_SPEED", NULL),
      END_OF_FIELDS },
     .priority    = 7}
    ...
    {"Garmin Autopilot: System Voltage",
     ...
     { COMPANY(229),
      ...
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 158, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
      VOLTAGE_U16_10MV_FIELD("System Voltage"),
      END_OF_FIELDS },
     .priority    = 7}
    ...
    {"Garmin Autopilot: Turn Angle Order",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 2, "2"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 116, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Garmin Autopilot: Turn Angle Measured",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 2, "2"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 161, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Garmin Autopilot: Engine RPM A",
     ...
     { COMPANY(229),
      ...
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 240, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Garmin Autopilot: Engine RPM B",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 5, "5"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 239, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
      {.name = "Engine Speed", .size = BYTES(2), .resolution = 1, .unit = "rpm", .fieldType = "UFIX16"},
      END_OF_FIELDS },
     .priority    = 7}
    ...
    {"Garmin Autopilot: Response Setting",
     ...
     { COMPANY(229),
      ...
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 62, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Garmin Autopilot: Mode State",
     ...
     { COMPANY(229),
      ...
      MATCH_FIELD("Wrapper Byte 2", BYTES(1), 4, "4"),
      MATCH_FIELD("Field Group", BYTES(1), 5, "5"),
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 10, GARMIN_AUTOPILOT_FIELD),
      RESERVED_FIELD(BYTES(1)),
      LOOKUP_FIELD("Mode State", BYTES(1), GARMIN_AUTOPILOT_MODE_STATE),
      END_OF_FIELDS },
     .priority    = 7}
    ...
    {"Garmin Autopilot: Heartbeat",
     ...
     { COMPANY(229),
      ...
      MATCH_LOOKUP_FIELD(PK("Field"), BYTES(1), 3, GARMIN_AUTOPILOT_FIELD),
    ...
    {"Garmin: Button-Interface Idle Beacon",
     ...
     {COMPANY(229),
      ...
      {.name = "Idle Payload", .size = BYTES(5), .resolution = 1, .fieldType = "BINARY", .description = "Fixed 5-byte idle payload (01 11 02 19 00). The keypress content, which appears only while a key is pressed, is not represented here."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin keypad/button-interface (GRID) idle beacon carried in the Garmin 126720 proprietary container. The idle payload is a fixed 5-byte body (01 11 02 19 00); the keypress content, which appears only while a key is pressed, is not decoded here."}
    ...
    {"Garmin: Device-Presence / Master-Advertise Beacon",
     ...
     {COMPANY(229),
      ...
      {.name = "Protocol Magic", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "Little-endian u32 protocol/product magic, constant (0xD4909C97)."},
      ...
      {.name = "Device Role", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "Device-class/role discriminator: 0x0A on the Reactor autopilot, 0x00 on displays/GHC; mirrors Wrapper Byte 1."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin device-presence / master-advertise beacon, broadcast by Garmin nodes on the bus (Reactor autopilot, GHC, GPSMAP). The discriminator is the device role: Wrapper Byte 1 and body byte [16] are 0x0A on the Reactor (autopilot) and 0x00 on the displays/GHC, so the family advertises device presence and class. The body carries a constant protocol magic (0xD4909C97). A heartbeat/role advertisement with no event content."}
    ...
    {"Garmin: Display Version/Identity Handshake",
     ...
     {COMPANY(229),
      ...
      {.name = "Version Word", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "Little-endian u16; values 0x07E8=2024 / 0x07E9=2025 are calendar years (display/autopilot firmware-year sync)."},
      {.name = "Field 12", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p12: const 0x19"},
      {.name = "Tail", .size = BYTES(1), .resolution = 1, .fieldType = "BINARY", .description = "From p13 onward; 0x00 on the short record. A 24-byte variant (Message ID 2308) carries a device-node id."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin version/identity handshake exchanged between the GPSMAP and the GHC. Two record types selected by the Message ID: 2307 (14-byte short) and 2308 (24-byte long). The little-endian u16 at body offset [10:12] carries a calendar year (firmware-year version sync); the long record additionally carries a device-node id."}
    ...
    {"Garmin: GHC Config Key-Value Entry",
     ...
     {COMPANY(229),
      ...
      {.name = "Config Key", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "Little-endian u32 hashed config/menu key; occupies the Message-ID slot and the first body word."},
     ...
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC configuration / menu key-value entry. Each entry is a hashed 32-bit config key (in the Message-ID slot and first body word) followed by a fixed type/value envelope. The wrapper bytes 0x0B 0x0B mark the GHC config family group, shared with the config-table beacon. The keys are hashes, so the human field names are not recoverable from the wire."}
    ...
    {"Garmin: GHC Config-Table Beacon",
     ...
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC config-table beacon -- the header/descriptor that accompanies the config key-value entries (shared 0x0B 0x0B wrapper). A fixed payload (Message ID 1, body 01 00 06 00 00 00): a descriptor with count=1, type=6."}
    ...
    {"Garmin: GHC Node-Status Report",
     ...
     {COMPANY(229),
      ...
      {.name = "Node ID", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "Little-endian u32; varies per reported node. The same field is fixed in the self-status family and is that node's own address."},
      {.name = "Node Record", .size = BYTES(2), .resolution = 1, .fieldType = "BINARY", .description = "Per-node status entries from p20 to end; a variable-length list (1..N entries). The per-entry field layout is not decoded."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC node-status report. A variable-length record carrying a fixed 8-byte status header, a 32-bit node id, then a variable-length list of per-node status entries. The per-entry field layout is not decoded, so the trailing list is left as binary."}
    ...
    {"Garmin: GHC Self-Status Beacon",
     ...
     {COMPANY(229),
      ...
      {.name = "Status Header", .size = BYTES(8), .resolution = 1, .fieldType = "BINARY", .description = "p8:16 = 01 01 03 0f 08 ff 0f 00 (constant report header, same as the node-status report)."},
      {.name = "Node ID", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "Little-endian u32; the emitting GHC's own node address (fixed)."},
      ...
      {.name = "Status", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "p22:24 LE: a varying status word."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC self-status beacon -- the single-node counterpart of the node-status report. A fixed 8-byte header, the GHC's own 32-bit node id, then a small sequence counter and a 2-byte status word. The status word's value semantics are GHC-internal."}
    ...
    {"Garmin: GPSMAP 86xx Device Health Telemetry",
     ...
     {COMPANY(229),
      ...
      FLOAT_FIELD("Scalar 1", "FLOAT", "Little-endian float32 (slots 0-2 carry equal values)."),
      FLOAT_FIELD("Scalar 2", "FLOAT", "Little-endian float32."),
      FLOAT_FIELD("Scalar 3", "FLOAT", "Little-endian float32."),
      {.name = "Reserved A", .size = BYTES(24), .resolution = 1, .fieldType = "BINARY", .description = "Six little-endian float32 slots, reserved (0.0)."},
      FLOAT_FIELD("Utilization 1", "FLOAT", "Little-endian float32 percentage gauge, capped at 99.99."),
      FLOAT_FIELD("Utilization 2", "FLOAT", "Little-endian float32 percentage gauge, capped at 99.99."),
      FLOAT_FIELD("Utilization 3", "FLOAT", "Little-endian float32 percentage gauge, capped at 99.99."),
      FLOAT_FIELD("Utilization 4", "FLOAT", "Little-endian float32 percentage gauge, capped at 99.99."),
      {.name = "Reserved B", .size = BYTES(4), .resolution = 1, .fieldType = "BINARY", .description = "One little-endian float32 slot, reserved (0.0)."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GPSMAP internal device-health / utilization telemetry. This family has no Message ID slot: after the two wrapper bytes (0x04 0x04) the 56-byte body is fourteen little-endian IEEE-754 float32 values. Slots 0-2 are three equal scalars, slots 3-8 and 13 are reserved (0.0), and slots 9-12 are four percentage gauges capped at 99.99. The field names are not known."}
    ...
    {"Garmin: GPSMAP Data-Sync Record A",
     ...
     {COMPANY(229),
      ...
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Data", .size = BYTES(23), .resolution = 1, .fieldType = "BINARY", .description = "23-byte data record. Unset fields use the NMEA not-available sentinels (0xFF for unsigned, 0x7FFF/0x7FFFFFFF for signed), which expose the field boundaries (signed-16 fields end at body bytes [24] and [28]). The per-field widths/scales/names are not decoded, so the body is left as binary."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GPSMAP data-sync broadcast 'A' -- a fixed 23-byte data record. Unset fields use the NMEA not-available sentinels (0xFF for unsigned, 0x7FFF/0x7FFFFFFF for signed), which expose the field grid (signed-16 fields end at body bytes [24] and [28]). The per-field widths/scales/names are not decoded, so the body is left as binary."}
    ...
    {"Garmin: GPSMAP Data-Sync Record B",
     ...
     {COMPANY(229),
      ...
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Enum Block", .size = BYTES(6), .resolution = 1, .fieldType = "BINARY", .description = "p8:14 = early small-enum fields (p10/p11 in {00,03}, p12 in {00,01,03}), present even when the data fields are not-available."},
      {.name = "Data", .size = BYTES(28), .resolution = 1, .fieldType = "BINARY", .description = "Remaining data fields; unset fields use the not-available sentinels (0xFF / 0x7FFF/0x7FFFFFFF), which expose signed-16 boundaries at body bytes [29],[33],[37],[41]. The per-field widths/scales/names are not decoded."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GPSMAP data-sync broadcast 'B' -- a fixed 42-byte data record, the larger sibling of the data-sync 'A' record. Carries a small early enum block (always present) then a wider data section. Unset fields use the not-available sentinels (0xFF/0x7FFF), which expose the signed-field boundaries. The per-field widths/names are not decoded."}
    ...
    {"Garmin: GLM Lighting Control",
     ...
     {COMPANY(229),
      ...
      END_OF_FIELDS},
     .priority = 7,
     .explanation = "Garmin proprietary marine-lighting and audio-zone control sub-protocol (Garmin Lighting Module, GLM) carried inside the Garmin 126720 proprietary container, selected by Sub-protocol ID 2711. The container framing (Manufacturer/Industry trio, Sub-protocol ID, two wrapper bytes, 16-bit Message ID, then a message body) matches the sibling Garmin 126720 AHRS records. The per-message body fields are not yet byte-decoded, so the body is left as binary."}
    ...
    {"Alert",
     ...
     {LOOKUP_FIELD("Alert Type", 4, ALERT_TYPE),
      ...
      LOOKUP_FIELD("Temporary Silence Status", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Acknowledge Status", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Escalation Status", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Temporary Silence Support", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Acknowledge Support", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Escalation Support", 1, YES_NO_1BIT),
      RESERVED_FIELD(2),
    ...
    {"Tracked Target Data",
     ...
     {UINT8_FIELD("SID"),
      ...
      LOOKUP_FIELD("Reported Target", 1, YES_NO_1BIT),
    ...
    {"AIS Class B Position Report",
     ...
     {LOOKUP_FIELD("Message ID", 6, AIS_MESSAGE_ID),
      ...
      LOOKUP_FIELD_DESC("Integrated Display", 1, YES_NO_1BIT, "Whether the unit can show messages 12 and 14"),
      LOOKUP_FIELD("DSC", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Band", 1, AIS_BAND),
      LOOKUP_FIELD("Can handle Msg 22", 1, YES_NO_1BIT),
    ...
    {"AIS Aids to Navigation (AtoN) Report",
     ...
     {LOOKUP_FIELD("Message ID", 6, AIS_MESSAGE_ID),
      ...
      LOOKUP_FIELD("Off Position Indicator", 1, YES_NO_1BIT),
      LOOKUP_FIELD("Virtual AtoN Flag", 1, YES_NO_1BIT),
    ...
    {"AIS Addressed Binary Message",
     ...
     {LOOKUP_FIELD("Message ID", 6, AIS_MESSAGE_ID),
      ...
      RESERVED_FIELD(6),
      LOOKUP_FIELD("Retransmit flag", 1, YES_NO_1BIT),
      RESERVED_FIELD(1),
      UINT16_FIELD("Number of Bits in Binary Data Field"),
      BINARY_FIELD("Binary Data", LEN_VARIABLE, NULL),
      END_OF_FIELDS},
    ...
    */
    ...
    {"Mercury: Alarm",
     ...
     {COMPANY(144),
      ...
      {.name = "Number Of Faults", .size = BITS(6), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Count of fault records that follow (maximum 17)."},
     ...
     .repeatingCount1 = 13,
     .repeatingStart1 = 11,
     .explanation = "Mercury proprietary display alarm PGN. A fixed header (6 bit-fields) carries a fault-record count (maximum 17), followed by that many 12-byte fault records (12 bit-fields per record). The value labels (fault catalog, feature/version enumerations) are not enumerated here."}
    ...
    {"Navico: Alert",
     ...
     {COMPANY(275),
      ...
      END_OF_FIELDS},
     .priority    = 3,
     .explanation = "Alert-record form of the Command 2 bulk report, selected by object key 0x8018. Carries the alert "
                    "identifier and handle plus indexes into the device's alert text tables."}
    ...
    {"Mercury: Proprietary Display Status",
     ...
     PACKET_FAST,
     {COMPANY(144),
      {.name = "Engine Instance", .size = BITS(4), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Engine instance (Mercury display header field)."},
      {.name = "Helm Number", .size = BITS(1), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Helm number (Mercury display header field)."},
      {.name = "Fault Number", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Fault number (Mercury display header field)."},
      {.name = "Message Version", .size = BITS(1), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Message version (Mercury display header field)."},
     ...
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Mercury proprietary display-status PGN. Distinct from the Navico 130822 UDB Database variants; the two are separated by the manufacturer code. A packed 8-bit display header (Engine Instance / Helm Number / Fault Number / Message Version) is followed by five fixed-width data fields (u8/u8/u16/u8/u32, little-endian). The first four data fields are presence-flagged against an all-ones not-available sentinel (0xFF / 0xFFFF); the u32 is always present. The data fields' value semantics/lookups are not enumerated here."}
    ...
    {"Mercury: Engine Status",
     ...
     {COMPANY(144),
      ...
      SIMPLE_DESC_FIELD("Sub Helm",
                        4,
                        "Helm-station sub-address (Mercury multi-helm); byte 3 low nibble. All-ones = unassigned / "
                        "not a helm station (the engine gateway); 0-14 = a physical helm display's configured index"),
      SIMPLE_DESC_FIELD("Helm",
                        4,
                        "Helm-station address (Mercury multi-helm); byte 3 high nibble. All-ones = unassigned / "
                        "not a helm station (the engine gateway); 0-14 = a physical helm display's configured index"),
    ...
    {"Mercury: Single Lever Mode",
     ...
     {COMPANY(144),
      ...
      END_OF_FIELDS},
     .priority = 7,
     .explanation = "Mercury proprietary single-lever (shift/throttle) control-mode status/request. The Single Lever Mode field reports the active lever-control mode; the trailing bits are reserved."}
    ...
    {"Simnet: Key Value",
     ...
     {COMPANY(1857),
      ...
      LOOKUP_FIELD_DESC("Network Group", BYTES(1), SIMNET_NETWORK_GROUP, "This can be either the Display Group, Units Group, Damping Group or Alarms Group, depending on which key is being set"),
    ...
    {"Simnet: Command AP Standby",
     ...
     {COMPANY(1857),
      UINT8_DESC_FIELD("Address", "NMEA 2000 address of commanded device"),
      RESERVED_FIELD(BYTES(1)),
      LOOKUP_FIELD("Network Group", BYTES(1), SIMNET_NETWORK_GROUP),
