...
Pgn pgnList[] = {
    ...
    {"ISO Address Claim",
     ...
     {SIMPLE_DESC_FIELD("Unique Number", 21, "ISO Identity Number"),
      ...
      {.name = "Device Instance Lower", .size = 3, .resolution = 1, .description = "ISO ECU Instance", .fieldType = "UNSIGNED_INTEGER", .rangeMax = 7},
      {.name = "Device Instance Upper", .size = 5, .resolution = 1, .description = "ISO Function Instance", .fieldType = "UNSIGNED_INTEGER", .rangeMax = 31},
    ...
    {"Seatalk: Wireless Keypad Light Control",
     ...
     PACKET_SINGLE,
     {COMPANY(1851),
      MATCH_FIELD(PK("Proprietary ID"), BYTES(1), 1, "Wireless Keypad Light Control"),
      UINT8_FIELD("Variant"),
    ...
    {"Navico: Engine Identity/Config",
     ...
     PACKET_SINGLE,
     {COMPANY(275),
      {.name = "Field A", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Run State", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Reserved", .size = BYTES(1), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Config Code", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Reserved", .size = BYTES(1), .resolution = 1, .fieldType = "RESERVED"},
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Maretron: Proprietary DC Breaker Current",
     ...
     {COMPANY(137),
      ...
      CURRENT_FIX16_DA_FIELD("Breaker Current"),
      RESERVED_FIELD(BYTES(2)),
      END_OF_FIELDS},
     .priority = 6}
    ...
    {"Lowrance: Temperature",
     ...
     PACKET_SINGLE,
     {COMPANY(140),
      LOOKUP_FIELD(PK("Temperature Source"), BYTES(1), TEMPERATURE_SOURCE),
    ...
    {"Maretron: Trip Volume",
     ...
     {COMPANY(137),
      ...
      LOOKUP_FIELD("Fluid Type", 4, TANK_TYPE),
      RESERVED_FIELD(4),
      {.name = "Trip Volume", .size = BYTES(3), .resolution = 0.001, .fieldType = "UNSIGNED_INTEGER"},
      END_OF_FIELDS},
     .priority = 5}
    ...
    {"Maretron: 0-10 V",
     ...
     {COMPANY(137),
      UINT8_FIELD("SID"),
      UINT8_FIELD(PK("Data Instance")),
      {.name = "0-10 V Data", .size = BYTES(2), .resolution = 0.000244140625, .fieldType = "UNSIGNED_INTEGER"},
      RESERVED_FIELD(BYTES(2)),
      END_OF_FIELDS},
     .priority = 5}
    ...
    {"Maretron: Rotational Rate",
     ...
     {COMPANY(137),
      UINT8_FIELD("SID"),
      UINT8_FIELD(PK("Data Instance")),
      {.name = "Rotational Rate", .size = BYTES(2), .resolution = 0.25, .hasSign = true, .fieldType = "INTEGER"},
      RESERVED_FIELD(BYTES(2)),
      END_OF_FIELDS},
     .priority = 5}
    ...
    {"Maretron: Resistance",
     ...
     {COMPANY(137),
      UINT8_FIELD("SID"),
      UINT8_FIELD(PK("Data Instance")),
      {.name = "Resistance", .size = BYTES(2), .resolution = 0.01, .fieldType = "UNSIGNED_INTEGER"},
      RESERVED_FIELD(BYTES(2)),
      END_OF_FIELDS},
     .priority = 5}
    ...
    {"Navico: Depth Quality",
     ...
     PACKET_SINGLE,
     {COMPANY(275),
      {.name = "Instance", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Depth Quality", .size = BYTES(1), .resolution = 0.01, .hasSign = true, .fieldType = "INTEGER"},
      {.name = "Reserved", .size = BYTES(4), .resolution = 1, .fieldType = "RESERVED"},
      END_OF_FIELDS}}
    ...
    {"Lumishore: Light Status",
     ...
     PACKET_SINGLE,
     {COMPANY(798),
      UINT8_FIELD(PK("Zone Index")),
      UINT8_FIELD("Red"),
      UINT8_FIELD("Green"),
      UINT8_FIELD("Blue"),
      UINT8_FIELD("Cold White"),
      UINT8_FIELD("Warm White"),
      END_OF_FIELDS}}
    ...
    ,
    {"Garmin: Button-Interface Idle Beacon",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2707"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Message ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2307"},
      {.name = "Idle Payload", .size = BYTES(5), .resolution = 1, .fieldType = "BINARY", .description = "p8:13 = 01 11 02 19 00, byte-for-byte identical across all 83,115 frames from both Button-Interface units (srcs 6,7): no keypress occurred during any capture -- the keypress encoding is unobserved."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin Button-Interface (GRID/keypad, srcs 6 and 7) idle beacon. Static: a single distinct payload (01 11 02 19 00 body) byte-for-byte identical across all 83,115 frames from both keypad units and all logs (confirmed by scripts/garmin_fam2707_decode.py) -- so no button was pressed during any capture. The container head is fully resolved; the keypress content is capture-gated (it appears only when a key is pressed, which this corpus never captured)."}

    ,
    {"Garmin: Device-Presence / Master-Advertise Beacon",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2279"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=10"},
      {.name = "Message ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=259"},
      {.name = "Field 8", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p8: const 0x03"},
      {.name = "Field 9", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p9: const 0x0d"},
      {.name = "Protocol Magic", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "p10:14 LE u32 = 0xD4909C97, constant corpus-wide (protocol/product magic)"},
      {.name = "Field 14", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p14: const 0x01"},
      {.name = "Field 15", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p15: const 0x11"},
      {.name = "Device Role", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p16: 0x0A on the Reactor 40 (src 0), 0x00 on displays/GHC -- mirrors Wrapper Byte 1; a device-class/role discriminator"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin device-presence / master-advertise beacon, broadcast by every Garmin node on the bus (Reactor 40 src 0, GHC-50 src 9, GPSMAP srcs 10/11). Static beacon: only 2 distinct payloads corpus-wide. The single discriminating bit is the device ROLE -- Wrapper Byte 1 and body byte [16] are 0x0A on the Reactor (autopilot) and 0x00 on the displays/GHC, so the family advertises 'I am present and my class is X'. Body carries a constant protocol magic 0xD4909C97. This is the wire analogue of the gfmsld net_sync rx_master_advertise@0x30C610 master-election beacon (which uses family 2560 for the lighting controllers). No event content -- a heartbeat/role advertisement."}

    ,
    {"Garmin: Display Version/Identity Handshake",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2272"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Subtype", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p8: 01/00/0c"},
      {.name = "Field 9", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p9: const 0x12"},
      {.name = "Version Word", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "p10:12 LE u16; observed 0x0FD0=4048, 0x07E8=2024, 0x07E9=2025 (2024/2025 = calendar year; display<->AP firmware/year sync)"},
      {.name = "Field 12", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p12: const 0x19"},
      {.name = "Tail", .size = BYTES(1), .resolution = 1, .fieldType = "BINARY", .description = "p13 onward; const 0x00 on the short record, extends to a 24-byte variant (Message ID 2308) carrying a node id 90/50 e8/34 bf/be 1c 01"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin display version/identity handshake exchanged between the GPSMAP 86xx (srcs 10/11) and the GHC-50 (src 9). Extremely low cardinality (only 10 distinct payloads corpus-wide) -- a handshake, not live telemetry. Two record types via the Message ID: 2307 (0x0903, 14-byte short) and 2308 (0x0904, 24-byte long). The notable decoded field is the little-endian u16 at body offset [10:12] which takes 2024/2025 = calendar years (a firmware/year version sync); the long record additionally carries a device-node id."}

    ,
    {"Garmin: GHC Config Key-Value Entry",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2558"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=11"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=11"},
      {.name = "Config Key", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "p6:10 LE u32 -- a hashed config/menu key (57 distinct, FNV-like); occupies the Message-ID slot + first body word"},
      {.name = "Type", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p10: const 0x06"},
      {.name = "Reserved", .size = BYTES(3), .resolution = 1, .fieldType = "BINARY", .description = "p11:14 = 00 00 00"},
      {.name = "Value Tag", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p14: const 0x07"},
      {.name = "Field 15", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p15: const 0x00"},
      {.name = "Value", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p16: 0x01 (the entry's small value)"},
      {.name = "Field 17", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p17: const 0x00"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC-50 configuration / menu key-value dump (also seen relayed by GPSMAP srcs 10/11). 57 distinct entries, each a hashed 32-bit config key (occupying the Message-ID slot and the first body word) followed by a fixed type/value envelope (06 .. 07 00 01 00). The wrapper bytes 0x0B 0x0B distinguish the GHC config family group (shared with the fam-2557 config-table beacon). The keys are FNV-style hashes, so the human field names are not recoverable from the wire; the container + key + envelope structure is confirmed."}

    ,
    {"Garmin: GHC Config-Table Beacon",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2557"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=11"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=11"},
      {.name = "Message ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=1"},
      {.name = "Count", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "p8:10 LE = 0x0001 (config-table descriptor)"},
      {.name = "Type", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "p10:12 LE = 0x0006"},
      {.name = "Reserved", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "p12:14 LE = 0x0000"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC-50 (src 9) config-table beacon -- the header/descriptor that accompanies the fam-2558 key-value entries (shared 0x0B 0x0B wrapper). Static: a single distinct payload (Message ID 1, body 01 00 06 00 00 00). Fully container-resolved; the body is a fixed descriptor (count=1, type=6)."}

    ,
    {"Garmin: GHC Node-Status Report",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=6471"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Message ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=774"},
      {.name = "Status Header", .size = BYTES(8), .resolution = 1, .fieldType = "BINARY", .description = "p8:16 = 01 01 03 0f 08 ff 0f 00 (constant report header)"},
      {.name = "Node ID", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "p16:20 LE; varies per reported node (e.g. 1ca48b31); the same id is fixed in fam 6472 (self) = this node's address"},
      {.name = "Node Record", .size = BYTES(2), .resolution = 1, .fieldType = "BINARY", .description = "p20:end = per-node status entries; variable-length list (payload length 30-39 = 1..N entries), runtime descriptor-bound"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC-50 node-status report (also relayed by GPSMAP srcs 10/11). Variable-length record (30-39 bytes) carrying a fixed 8-byte status header, a 32-bit node id, then a variable-length list of per-node status entries. Live telemetry (70,952 distinct payloads). The container head + the constant header + the node-id field are confirmed; the per-node entry field layout is a runtime descriptor list (the fam-5904 wall) so the trailing fields are left binary."}

    ,
    {"Garmin: GHC Self-Status Beacon",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=6472"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Message ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=771"},
      {.name = "Status Header", .size = BYTES(8), .resolution = 1, .fieldType = "BINARY", .description = "p8:16 = 01 01 03 0f 08 ff 0f 00 (constant report header, same as fam 6471)"},
      {.name = "Node ID", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32", .description = "p16:20 = 0x1CA48B31, FIXED corpus-wide = the emitting the emitting device's own node address"},
      {.name = "Field 20", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p20: const 0x01"},
      {.name = "Sequence", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8", .description = "p21: small counter 0x11/0x12"},
      {.name = "Status", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16", .description = "p22:24 LE: live-varying status word (d3/d7/d8 .. ) "},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GHC-50 (src 9) self-status beacon -- the single-node counterpart of the fam-6471 multi-node report. Fixed 8-byte header + the GHC's own 32-bit node id (0x1CA48B31, constant), then a small sequence counter and a 2-byte live status word. The fixed node id here confirms the Node ID field in fam 6471 (where it varies per reported node). The trailing status word varies live but its value semantics are GHC-internal."}

    ,
    {"Garmin: GPSMAP 86xx Device Health Telemetry",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=23"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=4"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=4"},
      FLOAT_FIELD("Scalar 1", "FLOAT", "LE f32; range ~4.9..731.5 in observed traffic (slots 0-2 carry equal values)"),
      FLOAT_FIELD("Scalar 2", "FLOAT", "LE f32"),
      FLOAT_FIELD("Scalar 3", "FLOAT", "LE f32"),
      {.name = "Reserved A", .size = BYTES(24), .resolution = 1, .fieldType = "BINARY", .description = "Six LE f32 slots, all 0.0 across the corpus (reserved/unused)"},
      FLOAT_FIELD("Utilization 1", "FLOAT", "LE f32 percentage, hard-capped at exactly 99.99 (4 percent gauges)"),
      FLOAT_FIELD("Utilization 2", "FLOAT", "LE f32 percentage, capped 99.99"),
      FLOAT_FIELD("Utilization 3", "FLOAT", "LE f32 percentage, capped 99.99"),
      FLOAT_FIELD("Utilization 4", "FLOAT", "LE f32 percentage, capped 99.99"),
      {.name = "Reserved B", .size = BYTES(4), .resolution = 1, .fieldType = "BINARY", .description = "One LE f32 slot, 0.0 across the corpus"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GPSMAP 86xx (srcs 10/11) internal device-health / utilization telemetry. This family has NO Message ID slot: after the two wrapper bytes (0x04 0x04) the 56-byte body is exactly fourteen little-endian IEEE-754 float32 values. Wire-solved across 152,213 frames (100% finite floats): slots 0-2 are three equal scalars (~4.9..731.5), slots 3-8 and 13 are reserved 0.0, and slots 9-12 are four percentage gauges hard-capped at exactly 99.99 (CPU/memory/bus utilisation style). The float widths and the 99.99 percent cap are wire-validated; the field NAMES need a GPSMAP symbol source."}
    ...
    {"Garmin: GPSMAP Data-Sync Record A",
     ...
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=1810"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Data", .size = BYTES(23), .resolution = 1, .fieldType = "BINARY", .description = "23-byte data record, mostly not-available in observed traffic: unsigned fields read 0xFF and signed fields 0x7FFF/0x7FFFFFFF (NMEA-style N/A sentinels). The N/A markers reveal field boundaries (s16 fields end at body bytes [24] and [28]); the populated fields are a GPSMAP nav/sensor sync the boat's GPSMAP has few sources for. Field layout is producer-firmware (RGN-walled #3119) bound."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GPSMAP 86xx (src 10) data-sync broadcast 'A' -- a fixed 23-byte data record. In observed traffic almost every field is the not-available sentinel (0xFF for unsigned, 0x7FFF/0x7FFFFFFF for signed), because the GPSMAP has few attached data sources; the N/A markers nonetheless expose the field grid (e.g. signed-16 fields end at body bytes [24] and [28]). The container head is confirmed; the per-field widths/scales/names belong to the GPSMAP producer firmware (RGN-walled) so the body is left binary with the N/A-marker note."}

    ,
    {"Garmin: GPSMAP Data-Sync Record B",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=1633"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2"},
      {.name = "Enum Block", .size = BYTES(6), .resolution = 1, .fieldType = "BINARY", .description = "p8:14 = early small-enum fields (p10/p11 in {00,03}, p12 in {00,01,03}), present even when the data fields are N/A"},
      {.name = "Data", .size = BYTES(28), .resolution = 1, .fieldType = "BINARY", .description = "Remaining data fields, mostly not-available in observed traffic (0xFF / 0x7FFF/0x7FFFFFFF). N/A markers expose s16 boundaries at body bytes [29],[33],[37],[41]. Field widths/scales/names are GPSMAP-producer-firmware bound."},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Garmin GPSMAP 86xx (src 10) data-sync broadcast 'B' -- a fixed 42-byte data record, the larger sibling of family 1810. Carries a small early enum block (always present) then a wider data section that is mostly not-available in observed traffic (0xFF/0x7FFF sentinels). The N/A grid exposes the signed-field boundaries. Container confirmed; body field widths/names producer-firmware-bound (RGN-walled)."}

    ,
    {"Garmin: GLM Lighting Control",
     126720,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(229),
      {.name = "Sub-protocol ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER", .unit = "=2711"},
      {.name = "Wrapper Byte 1", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Wrapper Byte 2", .size = BYTES(1), .resolution = 1, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Message ID", .size = BYTES(2), .resolution = 1, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Data", .size = BYTES(8), .resolution = 1, .fieldType = "BINARY"},
      END_OF_FIELDS},
     .priority = 7,
     .explanation = "Garmin proprietary marine-lighting and audio-zone control sub-protocol (Garmin Lighting Module, GLM) carried inside the Garmin 126720 proprietary container, selected by Sub-protocol ID 2711. The container framing (Manufacturer/Industry trio, Sub-protocol ID, two wrapper bytes, 16-bit Message ID, then a message body) matches the sibling Garmin 126720 AHRS records. The per-message body fields are serialized through Garmin's generic descriptor-driven framework and are not yet byte-decoded, so the body is left as binary."}
    ...
    {"Seatalk1: Pilot Mode",
     ...
     {COMPANY(1851),
      ...
      MATCH_LOOKUP_FIELD(PK("Seatalk1 Command"), BYTES(1), 132, SEATALK1_COMMAND),
    ...
    {"Seatalk1: Device Identification",
     ...
     {COMPANY(1851),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 240, SEATALK_MESSAGE_ID),
      MATCH_LOOKUP_FIELD(PK("command"), BYTES(1), 129, SEATALK_COMMAND),
      MATCH_LOOKUP_FIELD(PK("Seatalk1 Command"), BYTES(1), 144, SEATALK1_COMMAND),
      RESERVED_FIELD(BYTES(1)),
    ...
    {"Seatalk1: Display Brightness",
     ...
     {COMPANY(1851),
      ...
      LOOKUP_FIELD("Shared", BYTES(1), SEATALK_SHARED),
    ...
    {"Fusion: Media Control",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(2), 3, FUSION_MESSAGE_ID),
    ...
    {"Fusion: Sirius Control",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(2), 30, FUSION_MESSAGE_ID),
      UINT8_FIELD("Source ID"),
    ...
    {"Fusion: Set Source",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(2), 2, FUSION_MESSAGE_ID),
      UINT8_FIELD("Source ID"),
      END_OF_FIELDS}}
    ...
    {"Fusion: Set Zone Volume",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(2), 24, FUSION_MESSAGE_ID),
      UINT8_FIELD("Zone"),
      UINT8_FIELD("Volume"),
      END_OF_FIELDS}}
    ...
    {"Fusion: Set All Volumes",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(2), 25, FUSION_MESSAGE_ID),
      UINT8_FIELD("Zone1"),
      UINT8_FIELD("Zone2"),
      UINT8_FIELD("Zone3"),
      UINT8_FIELD("Zone4"),
    ...
    {"Airmar: Attitude Offset",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 32, AIRMAR_COMMAND),
    ...
    {"Airmar: Calibrate Compass",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 33, AIRMAR_COMMAND),
    ...
    {"Airmar: True Wind Options",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 34, AIRMAR_COMMAND),
    ...
    {"Airmar: Simulate Mode",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 35, AIRMAR_COMMAND),
    ...
    {"Airmar: Calibrate Depth",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 40, AIRMAR_COMMAND),
    ...
    {"Airmar: Calibrate Speed",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 41, AIRMAR_COMMAND),
    ...
    {"Airmar: Speed Filter None",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 43, AIRMAR_COMMAND),
    ...
    {"Airmar: Temperature Filter None",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 44, AIRMAR_COMMAND),
      MATCH_FIELD("Filter type", 4, 0, "No filter"),
      RESERVED_FIELD(4),
      DURATION_UFIX16_CS_FIELD("Sample interval",
    ...
    {"Airmar: NMEA 2000 options",
     ...
     PACKET_FAST,
     {COMPANY(135),
      MATCH_LOOKUP_FIELD(PK("Proprietary ID"), BYTES(1), 46, AIRMAR_COMMAND),
    ...
    {"Carling: DC Configuration Command",
     ...
     {COMPANY(176),
      ...
      RESERVED_FIELD(5),
      SIMPLE_FIELD("Breaker Mapping 3", 3),
      SIMPLE_FIELD("Inrush Delay", 4),
      SIMPLE_FIELD("Trip Delay", 4),
      UINT8_FIELD("Configuration Flags"),
      UINT8_FIELD("Current Rating"),
      UINT8_FIELD("Factory Max Rating"),
      SIMPLE_FIELD("Schedule B Load Shed Priority", 4),
      SIMPLE_FIELD("Schedule A Load Shed Priority", 4),
      UINT8_FIELD("Dim Value"),
      SIMPLE_FIELD("Breaker Group", 4),
      SIMPLE_FIELD("Flash Map Index", 4),
      END_OF_FIELDS}}
    ...
    {"Magnetic Variation",
     ...
     PACKET_SINGLE,
     {UINT8_FIELD("SID"),
      LOOKUP_FIELD(PK("Source"), 4, MAGNETIC_VARIATION),
      RESERVED_FIELD(4),
    ...
    {"DC Detailed Status",
     ...
     {UINT8_FIELD("SID"),
      INSTANCE_FIELD,
      LOOKUP_FIELD(PK("DC Type"), BYTES(1), DC_SOURCE),
      PERCENTAGE_U8_FIELD("State of Charge"),
    ...
    {"Wind Data",
     ...
     {UINT8_FIELD("SID"),
      ...
      LOOKUP_FIELD(PK("Reference"), 3, WIND_REFERENCE),
    ...
    {"Environmental Parameters",
     ...
     PACKET_SINGLE,
     {UINT8_FIELD("SID"),
      LOOKUP_FIELD(PK("Temperature Source"), 6, TEMPERATURE_SOURCE),
    ...
    {"Temperature",
     ...
     {UINT8_FIELD("SID"),
      INSTANCE_FIELD,
      LOOKUP_FIELD(PK("Source"), BYTES(1), TEMPERATURE_SOURCE),
      TEMPERATURE_FIELD("Actual Temperature"),
    ...
    {"Humidity",
     ...
     {UINT8_FIELD("SID"),
      INSTANCE_FIELD,
      LOOKUP_FIELD(PK("Source"), BYTES(1), HUMIDITY_SOURCE),
    ...
    {"Actual Pressure",
     ...
     {UINT8_FIELD("SID"),
      INSTANCE_FIELD,
      LOOKUP_FIELD(PK("Source"), BYTES(1), PRESSURE_SOURCE),
    ...
    */
    ...
    {"Sea Recovery: Watermaker Status",
     ...
     PACKET_FAST,
     {COMPANY(285),
      UINT8_FIELD("Message ID"),
      SIMPLE_FIELD("Watermaker Instance", 4),
      SIMPLE_FIELD("Operation State", 4),
      UINT16_FIELD("Prefilter Pressure"),
      UINT16_FIELD("Postfilter Pressure"),
      UINT16_FIELD("Operation Pressure"),
      SIMPLE_SIGNED_FIELD("Product Flow", BYTES(2)),
      SIMPLE_FIELD("Prefilter Pressure Status", 2),
      SIMPLE_FIELD("Postfilter Pressure Status", 2),
      SIMPLE_FIELD("Operation Pressure Status", 2),
      SIMPLE_FIELD("Product Salinity Status", 2),
      SIMPLE_FIELD("Filter Status", 2),
    ...
    {"Mercury: Alarm",
     130816,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN | PACKET_LOOKUPS_UNKNOWN,
     PACKET_FAST,
     {COMPANY(144),
      {.name = "Helm Number", .size = BITS(6), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Number Of Faults", .size = BITS(6), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Count of fault records that follow (firmware clamps to <=17)"},
      {.name = "Message Version", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Reserved", .size = BITS(16), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Feature", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Version", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Reserved", .size = BITS(6), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Fault Number", .size = BITS(6), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Fault Message Version", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Reserved", .size = BITS(16), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Fault Feature", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Fault Version", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Reserved", .size = BITS(8), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Reserved", .size = BITS(8), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Reserved", .size = BITS(10), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Popup ID", .size = BITS(14), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Reserved", .size = BITS(8), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Manufacturer ID Field Number", .size = BITS(10), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Reserved", .size = BITS(8), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Reserved", .size = BITS(2), .resolution = 1, .fieldType = "RESERVED"},
      END_OF_FIELDS},
     .priority = 7,
     .repeatingField1 = UINT8_MAX,
     .repeatingCount1 = 13,
     .repeatingStart1 = 11,
     .explanation = "Mercury (mfg 144) proprietary display alarm PGN, decoded by Garmin gfmsld deserialize_pgn_130816 @0x2ED9B0. A fixed header (DDF reader 0x3808B0, descriptor pool 0x639680+0x20, 6 bit-fields) carrying a fault-record count (firmware clamps to <=17), followed by that many 12-byte fault records (DDF reader 0x380A20, descriptor pool 0x639680+0x30, 12 bit-fields per record). Field names are firmware-authoritative from the shared Mercury DDF descriptor pool at 0x639680; each field's bit width is the descriptor metadata kind word (the bit-level DDF engine 0x17147C tracks a bit cursor and rounds each record up to a byte boundary, matching the confirmed 12-byte record stride). Value labels (fault catalog, feature/version enums) are runtime/capture-gated and omitted."}
    ...
    {"Navico: Feature Unlock",
     ...
     PACKET_FAST,
     {COMPANY(275),
      {.name = "Session Nonce", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Record Count", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Feature Type", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Validity Flag", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Duration", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "CRC", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7}
    ...
    {"Mercury: Vessel Configuration",
     130817,
     PACKET_LOOKUPS_UNKNOWN | PACKET_NOT_SEEN,
     PACKET_FAST,
     {COMPANY(144),
      {.name = "Message Version", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Feature Count", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Feature", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Feature Setting", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .repeatingField1 = 5,
     .repeatingCount1 = 2,
     .repeatingStart1 = 6,
     .explanation = "Mercury proprietary vessel / feature configuration. A message-version byte and a feature count are followed by that many feature records, each carrying a 16-bit feature identifier and a 16-bit feature setting (value). The enumerations for the feature identifier and setting are not yet known."}
    ...
    {"Webasto: Status 2",
     ...
     PACKET_FAST,
     {COMPANY(540),
      UINT8_FIELD("CAN Address"),
      UINT8_FIELD("Device ID"),
      UINT32_FIELD("System Error"),
      UINT32_FIELD("System Status"),
      UINT8_FIELD("Fresh Air Blower Speed"),
      UINT8_FIELD("V-Series Output"),
      END_OF_FIELDS}}
    ...
    {"Webasto: HVAC Command",
     ...
     {COMPANY(540),
      UINT8_FIELD("CAN Address"),
      UINT8_FIELD("Blower Speed"),
      LOOKUP_FIELD("Unit On/Off", 2, OFF_ON),
      RESERVED_FIELD(6),
      TEMPERATURE_FIELD("Set Temperature"),
      SIMPLE_FIELD("ECO Mode", 2),
      SIMPLE_FIELD("Functional Mode", 2),
      SIMPLE_FIELD("Compressor", 2),
      RESERVED_FIELD(2),
      UINT8_FIELD("Mask"),
      END_OF_FIELDS},
     .priority = 3}
    ...
    {"Fusion: Media",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32772, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: Track Name",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32773, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT32_FIELD("Index"),
    ...
    {"Fusion: Artist Name",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32774, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT32_FIELD("Index"),
    ...
    {"Fusion: Album Name",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32775, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT32_FIELD("Index"),
    ...
    {"Fusion: Device Name",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32801, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: Zone Name",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32813, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Number")),
      STRINGVAR_FIELD("Name"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: Tuner",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32779, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: MARINE_TUNER",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32780, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT8_FIELD("Channel"),
      UINT8_FIELD("Signal Strength"),
      STRINGVAR_FIELD("Name"),
    ...
    {"Fusion: Marine Squelch",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32781, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT8_FIELD("Squelch"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: Marine Scan Mode",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32782, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
    ...
    {"Fusion: Menu Item",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32785, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
    ...
    {"Fusion: Aux Gain",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32787, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT8_FIELD("Gain"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: USB Repeat Status",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32788, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: Settings",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32789, FUSION_STATUS_MESSAGE_ID),
      UINT32_FIELD("Count"),
      LOOKUP_FIELD("ID", BYTES(4), FUSION_SETTING),
      UINT32_FIELD("Value"),
      END_OF_FIELDS},
    ...
    {"Fusion: Mute",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32791, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: Balance",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32792, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Zone")),
      UINT8_FIELD("VALUE"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: Low Pass Filter",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32793, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Zone")),
      UINT8_FIELD("Filter"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: Sublevels",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32794, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD("Zone 1"),
      UINT8_FIELD("Zone 2"),
      UINT8_FIELD("Zone 3"),
      UINT8_FIELD("Zone 4"),
    ...
    {"Fusion: EQ",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32795, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Zone")),
    ...
    {"Fusion: Volume Limits",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32796, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: Volumes",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32797, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD("Zone 1"),
      UINT8_FIELD("Zone 2"),
      UINT8_FIELD("Zone 3"),
      UINT8_FIELD("Zone 4"),
    ...
    {"Fusion: Capabilities",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32798, FUSION_STATUS_MESSAGE_ID),
      UINT16_FIELD("Zone 1"),
      UINT16_FIELD("Zone 2"),
      UINT16_FIELD("Zone 3"),
      UINT16_FIELD("Zone 4"),
    ...
    {"Fusion: Line Level Control",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32799, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Zone")),
      UINT8_FIELD("Control"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: Power State",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32800, FUSION_STATUS_MESSAGE_ID),
    ...
    {"Fusion: SiriusXM",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32802, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
    ...
    {"Fusion: SiriusXM Channel",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32804, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
    ...
    {"Fusion: SiriusXM Title",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32805, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
    ...
    {"Fusion: SiriusXM Artist",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32806, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT16_FIELD("Channel"),
      STRINGVAR_FIELD("Artist"),
      END_OF_FIELDS},
    ...
    {"Fusion: SiriusXM Content Info",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32807, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT16_FIELD("Channel"),
    ...
    {"Fusion: SiriusXM Category",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32808, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT16_FIELD("Channel"),
      STRINGVAR_FIELD("Name"),
      END_OF_FIELDS},
    ...
    {"Fusion: SiriusXM Signal",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32809, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT8_FIELD("Signal"),
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Fusion: SiriusXM Presets",
     ...
     PACKET_FAST,
     {COMPANY(419),
      MATCH_LOOKUP_FIELD(PK("Message ID"), BYTES(2), 32812, FUSION_STATUS_MESSAGE_ID),
      UINT8_FIELD(PK("Source ID")),
      UINT8_FIELD("Count"),
    ...
    {"BEP Marine: Proprietary PGN 130821",
     ...
     {COMPANY(295), BINARY_FIELD("Data", BYTES(221), ""), END_OF_FIELDS}}
    ,
    {"Mercury: Pop-up Notification",
     130821,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN | PACKET_LOOKUPS_UNKNOWN,
     PACKET_FAST,
     {COMPANY(144),
      SIMPLE_FIELD("Version", BITS(2)),
      SIMPLE_FIELD("Pop-up Count", BITS(8)),
      RESERVED_FIELD(BITS(6)),
      SIMPLE_FIELD("Pop-up ID", BITS(14)),
      RESERVED_FIELD(BITS(8)),
      SIMPLE_FIELD("Manufacturer ID Field Number", BITS(10)),
      RESERVED_FIELD(BITS(43)),
      SIMPLE_FIELD("Engine State", BITS(2)),
      RESERVED_FIELD(BITS(6)),
      SIMPLE_FIELD("Single Lever Mode", BITS(7)),
      RESERVED_FIELD(BITS(158)),
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .repeatingField1 = 5,
     .repeatingCount1 = 8,
     .repeatingStart1 = 7,
     .explanation = "Mercury display pop-up notification. A header (version + pop-up count) followed by a repeating set of pop-up records. Each pop-up record carries a nested variable-length button array (a per-record button count followed by that many button records) which the flat field model cannot represent; the repeating stride here is the scalar pop-up record only and is faithful for the zero-button case. Field names are taken from the device decoder's field-descriptor pool; their value labels (pop-up id, engine state, single-lever mode enumerations) are not enumerated in the decoder."}
    ...
    {"Navico: Alert",
     ...
     PACKET_FAST,
     {COMPANY(275),
      {.name = "Id", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Sub-type", .size = BYTES(1), .resolution = 1, .hasSign = false, .unit = "=2", .partOfPrimaryKey = true, .fieldType = "UINT8"},
      {.name = "Record Key", .size = BYTES(2), .resolution = 1, .hasSign = false, .unit = "=32792", .partOfPrimaryKey = true, .fieldType = "UINT16"},
      {.name = "Reserved", .size = BYTES(2), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Alert ID", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32"},
      {.name = "Handle", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32"},
      {.name = "Action Text Index", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Long Text Index", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Short Text Index", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Field 4", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      END_OF_FIELDS},
     .priority = 3}
    ...
    {"Navico: Keyed Parameter Table",
     ...
     {COMPANY(275),
      {.name = "Id", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Sub-type", .size = BYTES(1), .resolution = 1, .hasSign = false, .unit = "=1", .partOfPrimaryKey = true, .fieldType = "UINT8"},
      {.name = "Record Key", .size = BYTES(2), .resolution = 1, .hasSign = false, .partOfPrimaryKey = true, .fieldType = "UINT16"},
      {.name = "Type Tag", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Value", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Flags", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Parameter", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Reserved", .size = BYTES(1), .resolution = 1, .fieldType = "RESERVED"},
      {.name = "Signature", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      END_OF_FIELDS},
     .priority = 3}

    ,
    {"Mercury: Proprietary Display Status",
     130822,
     PACKET_INCOMPLETE | PACKET_INTERVAL_UNKNOWN,
     PACKET_FAST,
     {COMPANY(144),
      {.name = "Engine Instance", .size = BITS(4), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Firmware field engine_inst (Mercury display pool idx0)"},
      {.name = "Helm Number", .size = BITS(1), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Firmware field helm_number (Mercury display pool idx1)"},
      {.name = "Fault Number", .size = BITS(2), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Firmware field fault_number (Mercury display pool idx2)"},
      {.name = "Message Version", .size = BITS(1), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER", .description = "Firmware field message_version (Mercury display pool idx3)"},
      {.name = "Field 8", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Field 9", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Field 10", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Field 11", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Field 12", .size = BYTES(4), .resolution = 1, .hasSign = false, .fieldType = "UINT32"},
      END_OF_FIELDS},
     .interval = UINT16_MAX,
     .priority = 7,
     .explanation = "Mercury (manufacturer 144) proprietary display-status PGN, decoded structurally from the Garmin gfmsld N2K Mercury module (deserialize_pgn_130822 @0x2EDF90, ndp_n2k_mercury.c, unit 4431 aarch64). Distinct from the Navico (275) 130822 'Keyed Parameter Table' variant; the two are separated by the manufacturer-code match. The field layout is firmware-derived from the gfmsld DDF (descriptor-driven) bit-level deserializer: a packed 8-bit display header (Engine Instance / Helm Number / Fault Number / Message Version, names from the shared Mercury display field pool at 0x639680) followed by five fixed-width data fields (u8/u8/u16/u8/u32, little-endian). The first four data fields are presence-flagged against an all-ones not-available sentinel (0xFF / 0xFFFF); the u32 is always present. The data fields are anonymous in firmware (no descriptor names) and their value semantics/lookups are runtime/capture-gated."}
    ...
    {"Navico: NDP2k Alert",
     ...
     {COMPANY(275),
      {.name = "Instance", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Record ID", .size = BYTES(1), .resolution = 1, .hasSign = false, .fieldType = "UINT8"},
      {.name = "Alert Type", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Alert ID", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      {.name = "Alert State", .size = BITS(3), .resolution = 1, .hasSign = false, .lookup.type = LOOKUP_TYPE_PAIR, .lookup.function.pair = lookupALERT_STATE, .lookup.name = "ALERT_STATE", .fieldType = "LOOKUP"},
      {.name = "Action Flag", .size = BITS(1), .resolution = 1, .hasSign = false, .fieldType = "UNSIGNED_INTEGER"},
      {.name = "Alert Severity", .size = BITS(4), .resolution = 1, .hasSign = false, .lookup.type = LOOKUP_TYPE_PAIR, .lookup.function.pair = lookupALERT_TYPE, .lookup.name = "ALERT_TYPE", .fieldType = "LOOKUP"},
      {.name = "Value", .size = BYTES(2), .resolution = 1, .hasSign = false, .fieldType = "UINT16"},
      END_OF_FIELDS},
     .priority = 7}
    ...
    {"Mercury: Single Lever Mode",
     ...
     {COMPANY(144),
      ...
      END_OF_FIELDS},
     .priority = 7,
     .explanation = "Mercury proprietary single-lever (shift/throttle) control-mode status/request. The Single Lever Mode field reports the active lever-control mode; the trailing bits are reserved. Exact field bit-widths are resolved by the device firmware at runtime; the discriminator is modelled here as a 3-bit lookup."}
    ...
    {"Simnet: AIS Class B static data (msg 24 Part A)",
     ...
     PACKET_FAST,
     {COMPANY(1857),
      MATCH_FIELD(PK("Message ID"), 6, 0, "Msg 24 Part A"),
      LOOKUP_FIELD("Repeat Indicator", 2, REPEAT_INDICATOR),
      UINT8_FIELD("D"),
      UINT8_FIELD("E"),
      MMSI_FIELD("User ID"),
    ...
    {"Simnet: AIS Class B static data (msg 24 Part B)",
     ...
     PACKET_FAST,
     {COMPANY(1857),
      MATCH_FIELD(PK("Message ID"), 6, 1, "Msg 24 Part B"),
      LOOKUP_FIELD("Repeat Indicator", 2, REPEAT_INDICATOR),
      UINT8_FIELD("D"),
      UINT8_FIELD("E"),
      MMSI_FIELD("User ID"),
...
*/
    ...
    {"Xantrex: AC Status",
     ...
     {COMPANY(168),
      ...
      UINT8_FIELD("Number of Lines"),
      SIMPLE_FIELD("Line", 2),
      SIMPLE_FIELD("Acceptability", 2),
      SIMPLE_FIELD("Waveform", 3),
      RESERVED_FIELD(1),
      VOLTAGE_U16_10MV_FIELD("Voltage"),
      CURRENT_UFIX16_DA_FIELD("Current"),
      UINT16_FIELD("Frequency"),
      INT32_FIELD("Real Power", "W"),
      INT32_FIELD("Reactive Power", "VAR"),
      PERCENTAGE_I8_FIELD("Power Factor"),
      END_OF_FIELDS}}
    ...
    {"Xantrex: DC Source Configuration Status",
     ...
     PACKET_FAST,
     {COMPANY(168),
      UINT8_FIELD(PK("DC Source Instance")),
      VOLTAGE_U16_10MV_FIELD("DC UV Shutdown Level"),
      VOLTAGE_U16_10MV_FIELD("DC UV Warning Level"),
      VOLTAGE_U16_10MV_FIELD("DC UV Shutdown Delay"),
      VOLTAGE_U16_10MV_FIELD("DC UV Recover Level"),
      VOLTAGE_U16_10MV_FIELD("DC OV Shutdown Level"),
      VOLTAGE_U16_10MV_FIELD("DC OV Warning Level"),
      VOLTAGE_U16_10MV_FIELD("DC OV Shutdown Delay"),
      VOLTAGE_U16_10MV_FIELD("DC OV Recover Level"),
      END_OF_FIELDS}}
    ...
    {"Xantrex: AC Output Configuration Status",
     ...
     PACKET_FAST,
     {COMPANY(168),
      UINT8_FIELD(PK("AC Source Instance")),
      UINT8_FIELD("Number of Lines"),
      SIMPLE_FIELD("Line", 2),
      RESERVED_FIELD(6),
      VOLTAGE_U16_10MV_FIELD("Voltage"),
      UINT16_FIELD("Frequency"),
      UINT32_FIELD("Power Limit"),
      VOLTAGE_U16_10MV_FIELD("OV Fault Level"),
      VOLTAGE_U16_10MV_FIELD("UV Fault Level"),
      END_OF_FIELDS}}
    ...
    {"Xantrex: Charger Configuration Status",
     ...
     PACKET_FAST,
     {COMPANY(168),
      UINT8_FIELD(PK("Charge Instance")),
      UINT8_FIELD("Battery Instance"),
      VOLTAGE_U16_10MV_FIELD("Bulk Voltage"),
      UINT16_FIELD("Bulk Time"),
      VOLTAGE_U16_10MV_FIELD("Absorption Voltage"),
      UINT16_FIELD("Absorption Time"),
      VOLTAGE_U16_10MV_FIELD("Float Voltage"),
      UINT16_FIELD("Float Time"),
      VOLTAGE_U16_10MV_FIELD("Equalization Voltage"),
      VOLTAGE_U16_10MV_FIELD("Generic Charge Voltage"),
      UINT32_FIELD("Generic Charge Current"),
      END_OF_FIELDS}}
    ...
    {"Xantrex: AC Input Configuration Status",
     ...
     {COMPANY(168),
      ...
      SIMPLE_FIELD("Line", 2),
      RESERVED_FIELD(6),
      UINT16_FIELD("Breaker Size"),
      UINT16_FIELD("AC Lost Level"),
      VOLTAGE_U16_10MV_FIELD("AC UV Level"),
      UINT16_FIELD("AC UV Warning Level"),
      UINT16_FIELD("AC UV Delay"),
      VOLTAGE_U16_10MV_FIELD("AC OV Level"),
      UINT16_FIELD("AC OV Warning Level"),
      UINT16_FIELD("AC OV Delay"),
      UINT16_FIELD("AC UF Level"),
      UINT32_FIELD("AC OF Level"),
      END_OF_FIELDS}}
